...
Primary::Primary(): wxFrame( nullptr, 0, "SDIndex", wxDefaultPosition, wxSize( 980, 800 ) ) {
	...
	queryButton = new wxButton( this, 5, "Query",
								wxPoint( queryArea->GetPosition().x + queryArea->GetSize().x + xgap,
								queryArea->GetPosition().y ),
								buttonsize );

	copyToClipboardButton = new wxButton( this, 11, "Copy",
...
wxFont sdindexer::Primary::get_font1() {
...
void sdindexer::Primary::on_clear_clicked( wxCommandEvent& evt ) {
...
void sdindexer::Primary::on_to_lowercase_clicked( wxCommandEvent& evt ) {
...
void sdindexer::Primary::on_ommit_numbers_clicked( wxCommandEvent& evt ) {
...
void sdindexer::Primary::on_ommit_special_clicked( wxCommandEvent& evt ) {
...
void sdindexer::Primary::on_copy_clicked( wxCommandEvent& evt ) {

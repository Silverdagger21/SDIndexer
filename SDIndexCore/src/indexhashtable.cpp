...
bool sdindex::IndexHashtable::entry_exists(std::string* word) {
...
IndexHashtableEntry* sdindex::IndexHashtable::get_entry_copy(std::string* word) {
...
IndexHashtableEntry* sdindex::IndexHashtable::get_entry(std::string* word) {
